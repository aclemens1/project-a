...
const Burger: React.FC<IBurgerProps> = ( { onClick } ) => {
  ...
  return (
    <button onClick={handleClick} className="lg:hidden order-first md:order-last md:ms-4 ms-0 flex items-center justify-center w-10 h-10 rounded-full border-gray-200 border">
